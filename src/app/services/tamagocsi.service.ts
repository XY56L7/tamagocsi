...
import { Tamagocsi } from '../models/tamagocsi.model';
...
export class TamagocsiService {
  ...
  private updateStatus(): void {
    if (this.tamagocsi.isAlive) {
      // Éhség és szomjúság csökkentése idővel
      const now = new Date();
      ...
      // Ha túl éhes vagy szomjas, meghal
      if (this.tamagocsi.hunger <= 0 || this.tamagocsi.thirst <= 0) {
